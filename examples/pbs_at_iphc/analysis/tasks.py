...
from analysis.framework import Task, PbsWorkflow


class CreateChars(Task, PbsWorkflow, law.LocalWorkflow):
    """
    ...
    By default, CreateChars is a PbsWorkflow (first workflow class in the inheritance order,
